...
Animal.create(name: "Parakeet", is_tall: false, is_fast: true, has_sharp_teeth: false, has_forward_facing_eyes: true, has_spots: false, has_stripes: false, has_shell: false, has_tail: false, eats_meat: false, lives_in_sea: false, lives_on_land: false, can_fly: true, can_swim: false)
